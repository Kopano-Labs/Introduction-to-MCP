...
| HIGH | [20-THESIS SESSIONS](../20-THESIS%20SESSIONS/20-THESIS%20SESSIONS%20-%20Index.md) | Thesis discussion rounds: Chief Architect + Gemini/Hippocampus + Codex/Lead Developer + KC/Full Dev |
| CRITICAL | [Cursor Onboarding Directive - 2026-05-09](../18-PROTOCOLS/Cursor%20Onboarding%20Directive%20-%202026-05-09.md) | Cursor welcomed as local IDE execution surface under KC/Cassy; Step 1 bridge directive ready |
...
- [Kopano Context Foresight](../02-Strategy/Kopano%20Context%20Foresight.md) — long-range framing for Kopano Context as an AI-native operating layer.
...
- [Kopano Studio](../03-Architecture/Neural%20Link.md) — React/WebSocket real-time agent visualization GUI (Kopano Studio).
...
| Date            | Event                                                     |
| --------------- | --------------------------------------------------------- |
| Apr 15-17, 2026 | SA Startup Week Hack Day — Demo KasiLink + Kopano Context |
| Apr 30, 2026    | Phase 6 baseline: Kopano Labs gallery and registry        |
