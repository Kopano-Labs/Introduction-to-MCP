...
def extra_handlers(
    ...
    return {
        ...
        "KCA-0408": lambda: h_file("kopano-core/kopano/kc_training_api.py", "POST /seed-training and /seed-apprenticeship-250."),
        ...
        "KCA-0709": lambda: h_file("docs/swarm-ops/apprenticeship/kc_apprenticeship_250.json", "250 = 10x25 tasks; checkpoint every 50."),
        ...
        "KCA-1010": lambda: h_file("DEMO_DAY_10_PHASES_50_TASKS.md", "50 demo tasks vs 250 apprenticeship."),
        "KCA-1011": lambda: h_cmd(
            "activate dry-run count",
            [sys.executable, "-c", "import json;print(len(json.load(open('docs/swarm-ops/apprenticeship/kc_apprenticeship_250.json'))['tasks']))"],
        ),
