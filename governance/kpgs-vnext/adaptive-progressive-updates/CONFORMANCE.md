...
9. User-facing adaptive rendering profiles do not change the update's authority or truth semantics.
10. Private/transactional operations remain capability/policy gated and are never smuggled into a public offline cache lane.
